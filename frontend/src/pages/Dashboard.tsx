                ...
                <div className="flex gap-2">
                    ...
                    <div className="flex-1 relative">
                        <select
                            ...
                            className="w-full appearance-none rounded-xl bg-navy-900 border border-gray-700 text-white font-medium py-3 px-4 pr-8 shadow-sm focus:outline-none focus:ring-2 focus:ring-electric-blue focus:border-electric-blue transition-colors"
                        >
